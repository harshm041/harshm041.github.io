<%@ Page Title="" Language="C#" MasterPageFile="~/after_login.master" AutoEventWireup="true" CodeFile="role playing.aspx.cs" Inherits="role_playing" %>
...
<h1 style=" color:Black; font:bold;">Role Playing Games</h1><hr style=" border-width:medium; border-color:Black ;" />
<center><asp:Label ID="msg" runat="server" Visible="false" style=" font-size:small;" Text=""></asp:Label></center>
    <asp:DataList ID="roleplaying_list" runat="server" style=" margin-left:50px; margin-right:50px; margin-top:20px; margin-bottom:20px;" 
...
<ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Role playing" Name="game_type" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
