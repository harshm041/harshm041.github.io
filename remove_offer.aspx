<%@ Page Title="" Language="C#" MasterPageFile="~/admin_page.master" AutoEventWireup="true" CodeFile="remove_offer.aspx.cs" Inherits="remove_offer" %>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <asp:TextBox ID="Game_ID" runat="server" CssClass="round-md" ForeColor="Black" 
            MaxLength="3" placeholder="Enter Digits only"></asp:TextBox>
...
<div class="row">
    ...
    <hr />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [game_id], [game_name] FROM [offers_db]">
        </asp:SqlDataSource>
</div>
</asp:Content>
