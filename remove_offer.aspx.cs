...
public partial class remove_offer : System.Web.UI.Page
{
    ...
    protected void Remove_btn_Click(object sender, EventArgs e)
    {
        con.Open();
        String id = "", nm = "", img = "";
        String str = " select * from offers_db where game_id='" + Game_ID.Text + "' and game_name='" + Game_Name.Text + "'";
        ...
        {
            String str2 = "delete from offers_db where game_id='" + Game_ID.Text + "' and game_name='" + Game_Name.Text + "'";
