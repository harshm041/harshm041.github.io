...
public partial class add_product : System.Web.UI.Page
{
    ...
    protected void add_game_btn_Click(object sender, EventArgs e)
    {   
//check Product Exists or not 
        String id = "",nm="";
        con.Open();
        String str = "select * from games_db where game_name='" + Game_Name.Text + "' or game_id='"+Game_ID.Text+"'";
        ...
        if(id==Game_ID.Text || nm==Game_Name.Text)
            {
                ...
                err_msg.Text = "Game Already Exists";
...
//if product does'nt exists then add data to database
        else
            {
                ...
                String str2 = "insert into games_db values('"+Game_ID.Text+"','"+Game_Name.Text+"','"+Game_Price.Text+"','"+gametype.Text+"','"+Game_Details.Text+"','images/"+strname+"')";
                ...
                if (a > 0)
                    {
                        ...
                        err_msg.Visible = true;
                        err_msg.Text = "Game Product Successfully added";
