<%@ Page Title="Admin" Language="C#" MasterPageFile="~/admin_page.master" AutoEventWireup="true" CodeFile="addoffer.aspx.cs" Inherits="addoffer" %>
...
<div class="row">
    <div class="col-sm-12 ">
        ...
        <asp:TextBox ID="Game_ID" CssClass="round-md" ForeColor="Black" 
            runat="server" MaxLength="2" placeholder="Enter Digits only"></asp:TextBox>
        ...
        <asp:RegularExpressionValidator ID="gameid_validator" runat="server" 
            ErrorMessage="*(Enter 1 Or 2 digits only)" ControlToValidate="Game_ID" 
            ValidationExpression="^[0-9]{1,2}$"  Font-Size="X-Small" ForeColor="Red"></asp:RegularExpressionValidator>
...
<div class="row">
    ...
    <asp:Button ID="add_offer_btn" runat="server" CssClass="btn btn-success " 
        Text="Add Offer" onclick="add_offer_btn_Click"  />
        <hr />
</div>
</asp:Content>
