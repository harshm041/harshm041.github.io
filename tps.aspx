<%@ Page Title="" Language="C#" MasterPageFile="~/after_login.master" AutoEventWireup="true" CodeFile="tps.aspx.cs" Inherits="tps" %>
...
<h1 style=" color:Black; font:bold;">TPS Games</h1><hr style=" border-width:medium; border-color:Black ;" />
<center><asp:Label ID="msg" runat="server" Visible="false" style=" font-size:small;" Text=""></asp:Label></center>
    <asp:DataList ID="tps_list" runat="server" style=" margin-left:50px; margin-right:50px; margin-top:20px; margin-bottom:20px;" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="TPS" Name="game_type" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</div>
</asp:Content>
